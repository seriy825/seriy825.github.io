...
<head>
    ...
    <script>
        ...
        function initMap() {
            ...
            if (<?=$conferencetb->lat?>!==0 && <?=$conferencetb->lng?>!==0){
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to update conference record in the database.</p>
                    <form action="../index.php?act=update" method="post" >
                        <div class="form-group <?php echo (!empty($conferencetb->title_msg)) ? 'has-error' : ''; ?>">
                            <label>Conference Title</label>
                            <input type="text" name="title" class="form-control" value="<?= $conferencetb->title; ?>">
                            <span class="help-block"><?php echo $conferencetb->title_msg;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($conferencetb->date_msg)) ? 'has-error' : ''; ?>">
                            <label>Conference Date</label>
                            <input type="date" name="date" class="form-control" value="<?= $conferencetb->date; ?>">
                        </div>                       
                        <div class="form-group <?php echo (!empty($conferencetb->lat_msg)) ? 'has-error' : ''; ?>">
                            <label>Address: latitude </label>
                            <input type="text" id="lat" name="lat" class="form-control" value="<?= $conferencetb->lat; ?>">
                            <span class="help-block"><?php echo $conferencetb->lat_msg;?></span>
                        </div>
                        <div class="form-group <?php echo (!empty($conferencetb->lng_msg)) ? 'has-error' : ''; ?>">
                            <label>Address: longitude</label>
                            <input type="text" id="lng" name="lng" class="form-control" value="<?= $conferencetb->lng; ?>">
                            <span class="help-block"><?php echo $conferencetb->lng_msg;?></span>
                        </div>                       	
                        <div id="map"> </div>
                        <div class="form-group <?php echo (!empty($conferencetb->country_msg)) ? 'has-error' : ''; ?>">
                            <label>Conference Country</label>
                            <select name="country" class="form-control">
                                <option selected value="<?php echo $conferencetb->country;?>"><?=$conferencetb->country?></option>
                        ...
                        <div class="col text-center my-5">
                            <input type="submit" name="updatebtn" class="btn btn-success" value="Save">
